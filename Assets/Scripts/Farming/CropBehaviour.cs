        ...
        switch (stateToSwitch)
        {
            ...
            case CropState.Harvestable:
                ...
                if (!seedToGrow.regrowable)
                {
                    ...
                    //Pass the RemoveCrop function over to the Interactable Object so that will be called when the player picks it up
                ...
                else
                {
                    ...
                    harvestable.GetComponent<RegrowableHarvestBehaviour>().HarvestStatus(true);
                }
