...
public class Land : MonoBehaviour, ITimeTracker
{
    ...
    public void LoadLandData(LandStatus landStatusToSwitch, GameTimestamp lastWatered, FarmObstacleStatus obstacleStatusToSwitch)
    {
        ...
        if (obstacleObject != null) obstacleObject.transform.position = new Vector3(transform.position.x, obstacleObject.transform.position.y, transform.position.z);
    ...
    public CropBehaviour SpawnCrop()
    {
        ...
        cropObject.transform.position = new Vector3(transform.position.x, cropObject.transform.position.y + 0.5f, transform.position.z);
