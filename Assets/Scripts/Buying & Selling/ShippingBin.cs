...
{
    public static int hourToShip = 1;
    public static List<ItemSlotData> itemsToShop = new List<ItemSlotData>();
    ...
    public override void Pickup()
    {
        ...
        UIManager.Instance.TriggerYesNoPrompt($"؟{handSlotItem.name} ﻊﻴﺒﺗ ﻥﺃ ﺪﻳﺮﺗ ﻞﻫ", PlaceItemsInShippingBin);
    }
    ...
    void PlaceItemsInShippingBin()
    {
        ...
        itemsToShop.Add(new ItemSlotData(handSlot));
        ...
        foreach(ItemSlotData item in itemsToShop)
        {
    ...
    public static void ShipItems()
    {
        ...
        int moneyToReceive = TallyItems(itemsToShop);
