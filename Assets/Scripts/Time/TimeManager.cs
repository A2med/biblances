...
public class TimeManager : MonoBehaviour
{
    ...
    public Light sunTransform;
    private float indoorAngle = 90f;
    ...
    void UpdateSunMovement()
    {
        ...
        {
            sunTransform.transform.eulerAngles = new Vector3(indoorAngle, 0, 0);
            return;
        }
        ...
        //Apply the angle to the directional light, And adjust it's intensity
        sunTransform.transform.eulerAngles = new Vector3(sunAngle, 0, 0);
        sunTransform.intensity = Mathf.InverseLerp(0, 5, sunAngle);
    }
